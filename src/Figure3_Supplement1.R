...
grDevices::tiff('outputs/figures/Figure3_Supplement1.tiff', res=300, units='in', width=12.5, height=8.5)
...
plot.new()
text(0.5,0.55,expression(paste(italic("P. putida"))), cex=2)
...
plot(invexp.data$kt2440.cfu.24h~composition$C18,
...
mtext('(nean number of sequences in community inoculum)', side=1, line=5.5, cex=0.8)

model<-lm(invexp.data$kt2440.cfu.24h~composition$C18)
...
plot(invexp.data$kt2440.cfu.24h~divandgrowth$CPM7, 
     cex=1.5, pch=21, bg=palette_heat, 
...
model<-lm(invexp.data$kt2440.cfu.24h~divandgrowth$CPM7)
...
plot(invexp.data$kt2440.cfu.24h~divandgrowth$mgCO2.7, 
     cex=1.5, pch=21, bg=palette_heat, 
...
model<-lm(invexp.data$kt2440.cfu.24h~divandgrowth$mgCO2.7)
...
plot(invexp.data$kt2440.cfu.24h~divandgrowth$simp, 
     cex=1.5, pch=21, bg=palette_heat, 
...
model<-lm(invexp.data$kt2440.cfu.24h~divandgrowth$simp)
...
plot(invexp.data$kt2440.cfu.24h~divandgrowth$rao,
     cex=1.5, pch=21, bg=palette_heat, 
     ylim=c(3,7),xlim=c(0,0.2),
     xlab='', ylab=expression(paste(italic("P. putida"), " invasion at 24 hours (cells/ml)")),
     yaxt='n')
...
model<-lm(invexp.data$kt2440.cfu.24h~divandgrowth$rao)
...
plot(invexp.data$kt2440.cfu.24h~divandgrowth$kt2440_phydist, 
     cex=1.5, pch=21, bg=palette_heat, 
     ylim=c(3,7),
     xlab='',
     ylab='',
...
model<-lm(invexp.data$kt2440.cfu.24h~divandgrowth$kt2440_phydist)
